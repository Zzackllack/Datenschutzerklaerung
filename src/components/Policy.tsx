...
const Policy: React.FC = () => {
    return (
        <section id="policy-details" className="container mx-auto px-4 py-12 text-gray-200">
            ...
            <p className="mb-4">
                Diese Datenschutzerklärung informiert in umfassender und detaillierter Weise über Art, Umfang und Zweck der Erhebung, Verarbeitung und Nutzung personenbezogener Daten im Rahmen der Bereitstellung und Nutzung sämtlicher Webseiten, die unter der Second-Level-Domain <strong>zacklack.de</strong> betrieben werden. Die nachfolgenden Bestimmungen sind in der gebotenen Formulierung verfasst, um den Anforderungen der geltenden Datenschutz-Grundverordnung (DSGVO) sowie weiterer einschlägiger datenschutzrechtlicher Bestimmungen in ihrer Gänze zu genügen.
            </p>

            <h2 className="text-2xl font-semibold mt-8 mb-4">1. Allgemeine Hinweise und Pflichtinformationen</h2>
            <p className="mb-4">
                Personenbezogene Daten im Sinne dieser Erklärung sind alle Informationen, welche sich auf eine identifizierte oder identifizierbare natürliche Person beziehen – hierzu zählen insbesondere Name, Anschrift, E-Mail-Adresse, Telefonnummer, IP-Adresse sowie sämtliche weitere Daten, die unter Berücksichtigung der Umstände der Verarbeitung einer Identifizierung der betroffenen Person ermöglichen.
                <br /><br />
                ...
                [Ihre Anschrift]
                <br />
                E-Mail: <a href="mailto:[Ihre E-Mail-Adresse]" className="text-blue-400 underline">[Ihre E-Mail-Adresse]</a>
                <br />
                Telefon: [Ihre Telefonnummer]
                <br /><br />
                Diese Datenschutzerklärung gilt für sämtliche Datenverarbeitungen im Zusammenhang mit der Nutzung unserer Webangebote unter der Domain <strong>zacklack.de</strong>.
            </p>
            ...
            <p className="mb-4">
                ...
                <br /><br />
                Im Rahmen der Inanspruchnahme der Cloudflare-Dienste werden technische Daten, namentlich Ihre IP-Adresse, Zugriffszeiten sowie spezifische Informationen zu Ihrem Endgerät, an Server von Cloudflare übermittelt und dort verarbeitet. Diese Datenübertragung erfolgt auch unter Zuhilfenahme von SSL/TLS-Verschlüsselung und erfolgt auf Grundlage berechtigter Interessen im Sinne des Art. 6 Abs. 1 lit. f DSGVO. Eine Übermittlung in Drittstaaten, insbesondere in die Vereinigten Staaten, erfolgt unter Einhaltung vertraglicher Garantien, die ein adäquates Datenschutzniveau sicherstellen.
                <br /><br />
                Weitere Einzelheiten entnehmen Sie bitte der Datenschutzerklärung von Cloudflare unter:{" "}
                <a href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">
            ...
            <p className="mb-4">
                ...
                <a href="https://umami.is/" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">
                    https://umami.is/
                </a>.
            </p>
            ...
            <p className="mb-4">
                Zur einheitlichen Darstellung typografischer Elemente wird auf unserer Webseite der Dienst Google Fonts verwendet. Hierbei werden Schriftarten von den Servern der Google Inc. geladen. Durch diese Einbindung werden technische Daten wie Ihre IP-Adresse und andere für die Darstellung notwendige Informationen an Google übermittelt. Diese Datenübertragung erfolgt ausschließlich zur Sicherstellung einer konsistenten und ansprechenden visuellen Darstellung unserer Inhalte.
                <br /><br />
                Die Nutzung von Google Fonts basiert auf der Grundlage berechtigter Interessen, ohne dass eine weitergehende Profilerstellung stattfindet. Es besteht kein Vertrag zur Auftragsverarbeitung mit Google. Weitere Informationen hierzu finden Sie in der Datenschutzerklärung von Google unter:{" "}
                <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">
